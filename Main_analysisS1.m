...
%% visualize LFP data
LFPanalysis.visualizeLFPS1(Projfolder,'savefig',true,'figpath',fullfile(Projfolder,'Results'));
...
ModOrds = LFPanalysis.FindModelOrderS1(Projfolder,'recalc',true);

%% Estimate PDC, calculate statistics based on permutation test
% (2) estimate pdc based on MVAR coefficients
LFPanalysis.EstimatePDC_STOKS1(Projfolder,'Normalize','All','recalc',false,'plotfig',false);
